        ...
        <div class="card">
            ...
            <form action="{{route('password.request')}}" method="POST" role="form">
                ...
                <div class="field">
                    ...
                    <p class="control">
                        <input class="input {{$errors->has('email') ? 'is-danger' : ''}}" type="text" name="email" id="email" placeholder="name@example.com" autofocus>
                    </p>
                    @if($errors->has('email'))
                ...
                <div class="field">
                    <button class="button is-primary is-outlined is-full-width">{{ __('Reset Password') }}</button>
                </div>
            </form>
